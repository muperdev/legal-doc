...
export function AnimatedButton({
  ...
  return (
    <Link
      ...
      onClick={onClick}
      className={cn(
        'group relative inline-flex items-center justify-center gap-x-4 text-base font-medium py-3 px-4 text-white border border-transparent overflow-hidden',
      ...
      {...props}
    >
      <span className="relative z-10 inline-flex items-center gap-x-4 transition-all duration-500 ease-in-out group-hover:text-black">
        {children}
      </span>
    </Link>
  )
